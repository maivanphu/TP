...
namespace DAOVente
{
    ...
    public partial class VenteEntities : DbContext
    {
        ...
        public virtual DbSet<LIGNECDE> LIGNECDE { get; set; }
        ...
        public virtual ObjectResult<spEmploye_Result> spEmploye()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spEmploye_Result>("spEmploye");
        }
    }
}
